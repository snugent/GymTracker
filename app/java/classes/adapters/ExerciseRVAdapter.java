...
public class ExerciseRVAdapter extends RecyclerView.Adapter<ExerciseRVAdapter.ItemViewActivity>{
    ...
    public ExerciseRVAdapter(HashMap<String, Exercise> exercises){
    ...
    @Override
    public void onBindViewHolder(ItemViewActivity exerciseViewHolder, int pos) {
        Exercise mExercise;
        mExercise= exercises.get(pos);
        exerciseViewHolder.tvDetail.setText(mExercise.getName());
        exerciseViewHolder.tvHeading.setText(mExercise.getType());
    }
